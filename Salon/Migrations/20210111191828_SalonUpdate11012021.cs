...
{
    public partial class SalonUpdate11012021 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Marka = table.Column<string>(maxLength: 60, nullable: false),
                    Model = table.Column<string>(maxLength: 60, nullable: false),
                    Kolor = table.Column<string>(maxLength: 20, nullable: true),
